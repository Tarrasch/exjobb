...
In STG-land, all values have the layout shown in figure
\ref{fig:heap_object} \cite{commentary_heap_objects}, these values are
...
% TODO: fields are *still* hard to understand ...
