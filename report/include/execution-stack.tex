...
\begin{figure}
  \centering
  \includegraphics{build/fig/stacks}
...
In STG-land, all heap object confirm to the template shown in figure \ref{heap_object} \cite{commentary_heap_objects}.
A \emph{stack frame} is just a STG-value whose
