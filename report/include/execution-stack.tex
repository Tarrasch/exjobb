...
will copy a few frames from the old chunk to the new chunk % cite TODO
, requiring
...
\begin{mdframed}
  ...
  ingoing arrows clarify where the content is copied from. Additionally,
  this figure also shows how info pointers and their layout are stored
  on the stack. It also shows where exactly the stack pointer is
  pointing.
  }
