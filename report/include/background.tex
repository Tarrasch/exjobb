...
The Rosetta Stone wiki contains a code sample in Ruby illustrating a stack
trace \cite{rosetta_stone_st}, reproduced here in figure
\ref{fig:ruby_stack_trace}. It should be noted that for some languages stack
traces could be printed at any time, not only after a crash.
...
\input{include/background/related-work.tex} % TODO, consider making chapter
