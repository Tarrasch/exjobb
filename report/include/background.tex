...
that a function will terminate and not return any error. % TODO: (source
...
verify that a function is total. % TODO (source: some really old paper by Turing?)
...
TODO: Forward referera till Peters jobb
