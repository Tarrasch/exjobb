...
But this has a serious drawback because a stack trace
involving the removed function can not exist, figure \ref{fig:optimization} highlights the
problem. In conclusion, an implementation of stack traces that have no
