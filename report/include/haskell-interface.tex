...
\begin{itemize}
  \item
    ...
    provide the function: \mint{haskell}|toException :: e -> SomeException|
  \item
...
So when a value is three levels down in the exception hierarchy, it will
be wrapped in 3 layers as well. FORTSÄTTSKRIV
