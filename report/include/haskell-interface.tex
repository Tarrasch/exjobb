...
The term exception system is vague. What we mean with an exception
...
Java, do not have anything like the \texttt{throws} annotation
\footnote{Introduced in section \ref{sec:error_handling_in_haskell}.}
