...
\begin{abstract}
  ...
  the GHC stack. We will look at how to create GHC stack values and
  what Haskell API should be exposed to the programmers.
  The overhead can be kept small by utilizing laziness and the special linked list structure of the
