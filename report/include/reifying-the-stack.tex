...
overflow check described in section \ref{sec:structure_of_stack}
would automatically kick in as a copy-on-write mechanism. The stack value would then be a value with
